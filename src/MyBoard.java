...
public class MyBoard extends JFrame{
    ...
    final ImageIcon r = new ImageIcon("riddler1.png");
    final ImageIcon b = new ImageIcon("batman1.png");
    final ImageIcon j = new ImageIcon("joker1.png");
    ...
    public MyBoard(){
        ...
        JOptionPane.showMessageDialog(null,"Let's See You Prove Me Wrong Batman","PROVE IT!",JOptionPane.PLAIN_MESSAGE,r);
                    ...
                    if (button[row][col] == event.getSource()) {
                        ...
                        if (pTurn % 2 == 0 && grid[row][col] == 0) {
                            ...
                            if (checkWin()) {
                                aWinner = true;
                                gameOver = true;
                                JOptionPane.showMessageDialog(null,"                    Congratulations Batman! \n\n                       You proved me wrong!\n\nI guess the Jokers going back to Arkham Asylum.","Batman Wins!",JOptionPane.PLAIN_MESSAGE,b);

                                whoWon.setText("Player 1 Wins!");
                                whoWon.setFont(new Font("Arial", Font.BOLD, 15));
